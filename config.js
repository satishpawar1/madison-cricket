...
const MCC_CONFIG = {
  ...
  lions: {
    ...
    catchData: [
      ...
      {name:'Nikunj',     att:0,  tak:0},
      {name:'Kirtan',     att:0,  tak:0},
      {name:'Satish',     att:4,  tak:3},
      {name:'Ravi',       att:1,  tak:0},
      {name:'Prakrut',    att:2,  tak:0},
    ...
    catchByGame: {
      ...
      'Great Maratha': [
      {name:'Sunny(W) ©', att:5, tak:4},
      {name:'Chinmay', att:1, tak:0},
      {name:'Hardik', att:0, tak:0},
      {name:'Manish', att:1, tak:1},
      {name:'Mahesh', att:0, tak:0},
      {name:'Mayur R', att:0, tak:0},
      {name:'Nikunj', att:0, tak:0},
      {name:'Kirtan', att:0, tak:0},
      ...
      'Nashville Underdogs': [
      {name:'Sunny(W) ©', att:6, tak:4},
      {name:'Chinmay', att:2, tak:1},
      {name:'Hardik', att:0, tak:0},
      {name:'Manish', att:1, tak:1},
      {name:'Mahesh', att:1, tak:1},
      {name:'Mayur R', att:0, tak:0},
      {name:'Nikunj', att:0, tak:0},
      {name:'Kirtan', att:0, tak:0},
      {name:'Satish', att:1, tak:1},
      {name:'Ravi', att:0, tak:0},
      {name:'Prakrut', att:1, tak:0},
      {name:'Saurabh', att:0, tak:0},
      {name:'Amit', att:1, tak:1},
      {name:'KP', att:0, tak:0},
      {name:'Dyan (N)', att:0, tak:0},
